...
export default function GuestManagementQuickView({ summary }) {
  ...
  return (
    <div className="portal-card">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:gap-6 lg:gap-8 mb-4">
      ...
      {withoutQR > 0 && (
        <div className="flex items-center justify-between rounded-xl px-4 py-3 mb-3"
          ...
          <button onClick={() => navigate('/portal/rsvp')}
