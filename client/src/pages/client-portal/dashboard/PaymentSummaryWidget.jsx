...
export default function PaymentSummaryWidget({ events, compact }) {
  ...
  return (
    <div className="portal-card flex flex-col h-full">
      ...
      <div className={`flex flex-col ${compact ? 'flex-1' : 'md:flex-row md:items-start md:gap-6'}`}>

        {/* Outstanding total — left on tablet */}
        <div className={`flex-shrink-0 mb-4 ${compact ? 'w-full flex-1 flex flex-col justify-center' : 'md:w-56 md:mb-0'}`}>
          <div className="rounded-2xl p-4 md:p-5 text-center flex-1 flex flex-col justify-center"
            ...
            {totalOutstanding > 0 && (
              <button className="mt-4 w-full py-3 rounded-xl font-semibold text-sm cursor-pointer border-none transition-all duration-200 hover:brightness-110"
